...
## What this is not
This is a collection of notes on various topics, and is not intended to be a substitute for a textbook or a course. More specifically, it is not a replacement for a course without any prerequisites, but rather a supplement to it. It is highly recommended to have a good understanding of the prerequisites before reading these. I have tried to list the prerequisites for each topic in their 'Introduction' sections, but it is not exhaustive.
