...
6. **Combine.**
    ...
    Steps 4 and 5 together give $\prod_{m=1}^{n} \varphi_{n,m}(t) \to e^{-t^2 \sigma^2 / 2}$ pointwise. By the [continuity theorem](../../convergence/continuity), $S_n \xrightarrow{d} N(0, \sigma^2)$. $\square$
</Steps>
</TabItem>
</Tabs>
</Aside>
