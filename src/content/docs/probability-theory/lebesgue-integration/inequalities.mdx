...
![A non-negative function g dominating the scaled indicator step L·1 on the region B](/assets/images/probability-theory/lebesgue-integration/tail-bound.svg)
...
![A parabola centered at the mean dominating a two-sided indicator step outside the band μ±a](/assets/images/probability-theory/lebesgue-integration/chebyshev.svg)
...
![A convex curve sagging below its chord, with the Jensen gap between φ(E[X]) on the curve and E[φ(X)] on the chord](/assets/images/probability-theory/lebesgue-integration/jensen.svg)
