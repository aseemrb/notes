...
<div style="display: grid; grid-template-columns: 1fr; gap: 2rem; margin: 2rem 0;">
  <div>
    <img src="/assets/images/probability-theory/lebesgue-integration/non-negative-approx.svg" alt="Approximating a non-negative function" />
    <p style="font-size: 0.8rem; text-align: center; color: var(--sl-color-gray-3); margin-top: 0.5rem;">
      We approximate $f$ by clipping its height at $n$ and restricting its domain to a set $E_n$ of finite measure.
      Shown: <span style="color: #ec4899;">$h_1 = (f \wedge 1) \mathbf{1}_{E_1}$</span> and <span style="color: #3b82f6;">$h_2 = (f \wedge 2) \mathbf{1}_{E_2}$</span>.
    </p>
  </div>
</div>
