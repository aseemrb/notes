...
$$
so $S_n/n \xrightarrow{P} \mu$. $\square$
</TabItem>
</Tabs>
</Aside>
...
$$
This is $L^2$ convergence to $0$. Convergence in probability follows from Chebyshev as above. $\square$
</TabItem>
</Tabs>
</Aside>
...
3. **Combine.**
    ...
    Both summands tend to $0$, so $\mathbb{P}(|(S_n - a_n)/b_n| > \epsilon) \to 0$ for every $\epsilon > 0$. $\square$
</Steps>
</TabItem>
</Tabs>
</Aside>
