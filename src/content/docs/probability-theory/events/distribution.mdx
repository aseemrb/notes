...
![Continuous Distribution Inversion](/assets/images/probability-theory/distributions/inverse-strictly-increasing.svg)

*Finding $x$ such that $F(x) = \omega$ is straightforward.*

### Discontinuous / Jump Case

![Discontinuous Inversion with Jump](/assets/images/probability-theory/distributions/inverse-jump.svg)
