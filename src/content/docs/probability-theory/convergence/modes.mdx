...
$$
This means $\mathbb{P}(|X_n - X| > \epsilon) \to 0$, so $X_n \xrightarrow{P} X$.
</TabItem>
</Tabs>
</Aside>
...
$$
Since $X_n \xrightarrow{L^p} X$, the numerator goes to 0 as $n \to \infty$. Thus the probability goes to 0.
</TabItem>
</Tabs>
</Aside>
...
= \epsilon^p
$$
Since $\epsilon$ can be arbitrarily small, the limit must be 0. Thus $X_n \xrightarrow{L^p} X$.
</TabItem>
</Tabs>
</Aside>
