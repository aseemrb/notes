...
<Aside type="tip" icon="open-book" title="Definition: Probability space">
...
<Aside type="tip" icon="open-book" title="Definition: σ-field">
...
<Aside type="tip" icon="open-book" title="Examples: σ-fields">
<Tabs>
...
<Aside type="caution" icon="pencil" title="Exercise 1">
