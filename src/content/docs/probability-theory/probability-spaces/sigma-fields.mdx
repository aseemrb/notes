...
<Aside title="Probability space" icon="open-book">
...
<Aside title="σ-Field" icon="open-book">
...
<Aside title="Examples of σ-fields" icon="open-book">
<Tabs>
...
<Aside title="Exercise 1" type="caution" icon="pencil">
