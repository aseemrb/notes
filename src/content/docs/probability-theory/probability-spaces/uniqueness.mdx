...
<Aside type="tip" title="Definition: π-system" icon="open-book">
...
<Aside type="tip" title="Definition: λ-system" icon="open-book">
...
Let us note two important facts about $\pi$ and $\lambda$-systems:
<Aside type="caution" title="Fact (a): π-system + λ-system = σ-field" icon="open-book">
<Tabs>
...
<Aside type="caution" title="Fact (b): Complement in a λ-system" icon="open-book">
<Tabs>
<TabItem label="Statement">
...
Let us now look at a theorem that relates $\pi$-systems and $\lambda$-systems.
<Aside title="π-λ Theorem" icon="seti:smarty">
<Tabs>
<TabItem label="Statement">
...
Let us now look at a useful corollary of the $\pi$-$\lambda$ theorem.
<Aside type="caution" title="Corollary: Uniqueness of ProbabilityMeasure" icon="seti:smarty">
<Tabs>
<TabItem label="Statement">
