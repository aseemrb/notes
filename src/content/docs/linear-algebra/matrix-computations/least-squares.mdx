...
![The data vector b, its orthogonal projection p onto the plane C(A), and the perpendicular error e = b − p](/assets/images/linear-algebra/matrix-computations/projection.svg)
