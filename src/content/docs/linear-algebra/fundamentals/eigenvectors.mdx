...
<Aside type="tip" title="Definition: Eigenvalues and Eigenvectors" icon="open-book">
...
<Aside title="Claim: Invertibility" icon="seti:smarty">
<Tabs>
...
<Aside title="Claim: Similarity" icon="seti:smarty">
<Tabs>
  <TabItem label="Statement">
