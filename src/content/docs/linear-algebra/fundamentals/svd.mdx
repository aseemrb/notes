...
sidebar:
  order: 6
---
import SVDEllipse from '../../../../components/widgets/SVDEllipse.tsx';
...
<Aside type="tip" icon="open-book" title="Definition: SVD">
...
## Interactive: Unit circle to ellipse

For a $2 \times 2$ matrix
$$
A = \begin{pmatrix} a & b \\ c & d \end{pmatrix},
$$
the image of the unit circle under $v \mapsto Av$ is an ellipse. The axes of the ellipse are the **left singular vectors** $u_1, u_2$ scaled by the **singular values** $\sigma_1, \sigma_2$. The preimages of those axes, $v_1, v_2$, are the **right singular vectors** on the unit circle. Drag the sliders to edit the entries of $A$ and watch the singular vectors and values update.
